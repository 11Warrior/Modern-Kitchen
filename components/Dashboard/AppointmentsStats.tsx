...
const AppointmentsStats = () => {
    ...
    const { data: meetingStats } = useGetMeetingStats();
    ...
    const nextMeetings = userMeetings?.filter((meeting) => {
        ...
        const upcommingMeetingDateTime = new Date(`${meeting.date}T${meeting.time}`);
        return upcommingMeetingDateTime > currentDateTime;
    });

    const rightNextMeeting = nextMeetings?.[0];
            ...
            <Card className='w-[45%] hover:bg-linear-to-br hover:to-primary/60 hover:outline-2 hover:outline-[#7033ff]'>
                ...
                <CardContent className='mt-15'>
                    <div className='flex  justify-between'>
                        <div className='space-y-10'>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <div className=''>
                                    <h1 className='text-2xl'>Chef. Gordon Ramsay</h1>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <div className=''>
                                    <h1 className='text-2xl'>Thursday, January 1, 2026</h1>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <div className=''>
                                    <h1 className='text-2xl'>11:11</h1>
                    ...
                    <div className='flex items-center justify-center  mt-10'>
                        <p className=' text-xl text-muted-foreground'>+1 more upcomming appointment.</p>
                    </div>
                </CardContent>
            </Card>
        </div>
